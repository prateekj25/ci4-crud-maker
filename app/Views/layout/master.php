...
<head>
    ...
    <title>CI4 CRUD Maker | Dashboard</title>
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="<?= url_to('logout') ?>" role="button">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="<?= site_url('/') ?>" class="brand-link">
                <span class="brand-text font-weight-light">CI4 CRUD Maker</span>
            </a>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2024 <a href="#">CI4 CRUD Maker</a>.</strong> All rights reserved.
        </footer>
